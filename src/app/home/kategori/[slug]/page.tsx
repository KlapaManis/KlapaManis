...
export default async function KategoriPage({ params }: { params: { slug: string } }){
  ...
  return (
    ...
    <div className="min-h-screen w-full" style={{backgroundColor: bgColor}}>
      ...
      {/* List 1 menu 1 baris, tiap baris 45% layar */}
      <div className="w-full">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 space-y-3">
          {items.length===0 ? (
            ...
            <KategoriClient items={items as any} cardBg={cardBg} cardShadow={cardShadow} titleShadow={titleShadow} descShadow={descShadow} isWhiteCard={isWhiteCard} namaColor={namaColor} descColor={descColor} />
          )}
